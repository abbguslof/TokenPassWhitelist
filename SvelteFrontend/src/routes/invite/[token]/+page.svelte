...
{:else if valid}
	<div class="container">
		...
		<form on:submit|preventDefault={submit}>
			<input type="text" placeholder="Minecraft Username" bind:value={username} required title="Valid Minecraft username (3-16 characters, letters, numbers, underscores)" disabled={submitting} />
			<div class="captcha">
